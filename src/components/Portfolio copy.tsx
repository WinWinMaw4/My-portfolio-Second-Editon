...
export default function Portfolio() {
  ...
  // Categorized Technical Stack based on experience
  ...
  // Curated Case Studies representing 6 Years & 13+ Projects
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <nav className="border-b border-slate-800/80 bg-slate-900/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold tracking-tight text-white">Win Win Maw</span>
          </div>
          <div className="flex items-center gap-6 text-sm font-medium">
            <a href="#about" className="text-slate-400 hover:text-indigo-400 transition">About</a>
            <a href="#experience" className="text-slate-400 hover:text-indigo-400 transition">Career Growth</a>
            <a href="#projects" className="text-slate-400 hover:text-indigo-400 transition">Flagship Work</a>
            <a href="#skills" className="text-slate-400 hover:text-indigo-400 transition">Tech Stack</a>
          </div>
        </div>
      </nav>

      {/* Hero Section */}
      <header id="about" className="max-w-6xl mx-auto px-6 pt-20 pb-16 border-b border-slate-800/60">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-indigo-500/10 text-indigo-400 rounded-full text-xs font-semibold mb-6 border border-indigo-500/20">
          <Sparkles size={14} /> Open for International Remote & Relocation Roles
        </div>
        ...
        <p className="text-lg sm:text-xl text-slate-300 font-normal max-w-3xl mb-8 leading-relaxed">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          <div className="p-4 bg-slate-900/60 rounded-lg border border-slate-800">
            <div className="text-2xl font-bold text-indigo-400">6+ Years</div>
            <div className="text-xs text-slate-400">Industrial Tech Experience</div>
          </div>
          <div className="p-4 bg-slate-900/60 rounded-lg border border-slate-800">
            <div className="text-2xl font-bold text-teal-400">Next.js & React</div>
            <div className="text-xs text-slate-400">Primary Technical Focus</div>
          </div>
          <div className="p-4 bg-slate-900/60 rounded-lg border border-slate-800">
            <div className="text-2xl font-bold text-sky-400">Lead & Mentor</div>
            <div className="text-xs text-slate-400">Team Leadership & QA Lead</div>
          </div>
          <div className="p-4 bg-slate-900/60 rounded-lg border border-slate-800">
            <div className="text-2xl font-bold text-indigo-400">AWS & Edge</div>
            <div className="text-xs text-slate-400">S3, EC2, Amplify, Lambda@Edge</div>
          </div>
        </div>

        <div className="flex flex-wrap gap-4 items-center">
          <a href="https://linkedin.com/in/winwinmaw01" target="_blank" rel="noreferrer" 
             className="flex items-center gap-2 px-5 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg font-medium transition shadow-lg shadow-indigo-600/20">
            <LinkIcon size={18} /> LinkedIn Profile
          </a>
          <a href="https://github.com/WinWinMaw4" target="_blank" rel="noreferrer" 
             className="flex items-center gap-2 px-5 py-3 bg-slate-900 hover:bg-slate-800 text-white rounded-lg font-medium border border-slate-700 transition">
      ...
      <main className="max-w-6xl mx-auto px-6 py-16 space-y-20">
        ...
        <section id="experience">
          <h2 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
            <Terminal className="text-indigo-400" size={24} /> Career Growth & Leadership Path
          </h2>
          <p className="text-slate-400 text-sm mb-8">Continuous 6-year progression at Digital Insects (formerly Axle Tech).</p>

          <div className="space-y-6 relative border-l-2 border-slate-800 ml-4 pl-6">
            
            {/* Role 4 */}
            <div className="relative">
              <span className="absolute -left-[31px] top-1.5 h-4 w-4 rounded-full bg-indigo-500 border-4 border-slate-950"></span>
              <div className="bg-slate-900/40 p-5 rounded-xl border border-slate-800/80">
                <div className="flex flex-wrap justify-between items-start gap-2 mb-2">
                  <h3 className="text-lg font-bold text-white">Lead Project Coordinator, Manager & Mentor</h3>
                  <span className="text-xs px-2.5 py-1 bg-indigo-500/10 text-indigo-400 rounded-full border border-indigo-500/20">Sep 2024 – Present</span>
                </div>
            ...
            {/* Role 3 */}
            <div className="relative">
              <span className="absolute -left-[31px] top-1.5 h-4 w-4 rounded-full bg-slate-700 border-4 border-slate-950"></span>
              <div className="bg-slate-900/40 p-5 rounded-xl border border-slate-800/80">
                <div className="flex flex-wrap justify-between items-start gap-2 mb-2">
                  <h3 className="text-lg font-bold text-white">Senior Frontend Developer & UI/UX Specialist</h3>
                  <span className="text-xs px-2.5 py-1 bg-slate-800 text-slate-400 rounded-full">Sep 2024 – Jul 2025</span>
                </div>
            ...
            <div className="relative">
              ...
              <div className="bg-slate-900/40 p-5 rounded-xl border border-slate-800/80">
                <div className="flex flex-wrap justify-between items-start gap-2 mb-2">
                  <h3 className="text-lg font-bold text-white">Full-Stack Developer (React & Laravel)</h3>
                  <span className="text-xs px-2.5 py-1 bg-slate-800 text-slate-400 rounded-full">Sep 2022 – Aug 2024</span>
                </div>
                <p className="text-slate-300 text-sm leading-relaxed">
        ...
        <section id="projects">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 border-b border-slate-800 pb-6 gap-4">
            <div>
              <h2 className="text-2xl font-bold text-white mb-1 flex items-center gap-2">
                <FolderGit2 className="text-indigo-400" size={24} /> Flagship Engineering Case Studies
              </h2>
              <p className="text-slate-400 text-sm">Selected high-impact platforms out of 13+ engineered solutions.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {filteredProjects.map((project) => (
              <div 
                key={project.id} 
                className="group bg-slate-900/60 rounded-xl border border-slate-800/80 hover:border-indigo-500/50 transition duration-300 p-6 flex flex-col justify-between"
              >
                <div>
                  <div className="flex justify-between items-start mb-2">
                    <span className="text-[11px] font-semibold px-2.5 py-1 bg-indigo-950/80 text-indigo-300 rounded border border-indigo-800/50">
                      {project.company} • {project.timeline}
                    </span>
                    {project.link && (
                      <a href={project.link} target="_blank" rel="noreferrer" className="text-slate-400 hover:text-indigo-400 transition">
                        <ExternalLink size={16} />
                      </a>
                    )}
                  </div>

                  <h3 className="text-xl font-bold text-white group-hover:text-indigo-400 transition mt-2 mb-1">
                    {project.name}
                  </h3>
                  <p className="text-xs text-indigo-400/90 font-medium mb-3">{project.role}</p>

                  <div className="mb-4 p-2.5 bg-slate-950/60 rounded border border-slate-800 text-xs text-emerald-400 font-mono">
                ...
                <div>
                  <div className="flex flex-wrap gap-1.5 mb-5">
                    {project.tags.map((tag) => (
                      <span key={tag} className="text-[11px] px-2 py-0.5 bg-slate-800 text-slate-300 rounded border border-slate-700/60 font-mono">
                        {tag}
                      </span>
                    ))}
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full py-2.5 bg-slate-800 hover:bg-indigo-600 text-slate-200 hover:text-white text-xs font-semibold rounded-lg transition border border-slate-700/60 flex items-center justify-center gap-2"
                  >
                    <Layers size={14} /> Read Architecture & Implementation Case <ArrowRight size={14} />
                  </button>
                </div>
              </div>
            ))}
        ...
        <section id="skills">
          <h2 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
            <Cpu className="text-indigo-400" size={24} /> Technical Stack & Expertise
          </h2>
          <p className="text-slate-400 text-sm mb-8">Modern full-stack technologies, design tools, and infrastructure practices.</p>

          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {skillCategories.map((group) => (
              <div key={group.category} className="p-5 bg-slate-900/40 rounded-xl border border-slate-800/80">
                <h3 className="text-xs font-semibold text-indigo-400 uppercase tracking-wider mb-4">{group.category}</h3>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 bg-slate-900/40 rounded-xl border border-slate-800">
              <Award className="text-indigo-400 mb-3" size={28} />
              <h3 className="text-lg font-bold text-white">Bachelor of Science (B.Sc), Computer Science</h3>
              <p className="text-slate-400 text-sm mb-2">Dagon University • Dec 2016 – Mar 2024</p>
              <p className="text-slate-300 text-sm leading-relaxed">
            ...
            <div className="p-6 bg-slate-900/40 rounded-xl border border-slate-800">
              <Globe className="text-indigo-400 mb-3" size={28} />
              <h3 className="text-lg font-bold text-white">Diploma in English & Career Communication</h3>
              <p className="text-slate-400 text-sm mb-2">SLD College • Nov 2024 – Mar 2026</p>
              <p className="text-slate-300 text-sm leading-relaxed">
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
          <div className="bg-slate-900 border border-slate-700 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 relative shadow-2xl">
            <button 
            ...
            <span className="text-xs text-indigo-400 font-semibold">{selectedProject.company} • {selectedProject.timeline}</span>
            <h3 className="text-2xl font-bold text-white mt-1 mb-1">{selectedProject.name}</h3>
            <p className="text-xs text-slate-400 font-medium mb-4">{selectedProject.role}</p>
            
            <div className="prose prose-invert max-w-none text-slate-300 text-sm mb-6 whitespace-pre-line leading-relaxed border-t border-b border-slate-800 py-4">
            ...
            <div className="flex justify-between items-center pt-2">
              {selectedProject.link ? (
                ...
                >
                  Visit Production Application <ExternalLink size={16} />
                </a>
              ) : <div />}
              
              <button
                onClick={() => setSelectedProject(null)}
                className="px-4 py-2 bg-slate-800 text-slate-300 hover:text-white rounded-lg text-sm font-medium transition"
              >
                Close Case Study
              </button>
            </div>
      ...
      {/* Footer */}
      <footer className="max-w-6xl mx-auto px-6 py-8 border-t border-slate-800 mt-20 text-center text-slate-500 text-sm">
